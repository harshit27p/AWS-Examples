...
```sh
aws sts assume-role \
--role-arn arn:aws:cloudformation:us-east-1:590183734648:stack/my-sts-fun-stack \
...
aws iam delete-access-key --access-key-id AXXXXXXXXXXXXXXXXXXXG --user-name sts-machine-user
